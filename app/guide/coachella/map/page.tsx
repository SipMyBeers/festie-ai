  ...
  return (
    <div className="noise pb-20 pt-safe">
      ...
      <div className="px-4 mb-6">
        <Link href="/planet/coachella" className="block">
          <div className="glass rounded-xl p-3.5 flex items-center gap-3 active:scale-[0.98] transition-transform">
            <div className="w-10 h-10 bg-gradient-to-br from-festie-purple to-festie-pink rounded-xl flex items-center justify-center shrink-0 shadow-lg shadow-purple-500/20">
              <svg className="w-5 h-5 text-white" fill="none" stroke="currentColor" strokeWidth={1.5} viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" d="M21 7.5l-2.25-1.313M21 7.5v2.25m0-2.25l-2.25 1.313M3 7.5l2.25-1.313M3 7.5l2.25 1.313M3 7.5v2.25m9 3l2.25-1.313M12 12.75l-2.25-1.313M12 12.75V15m0 6.75l2.25-1.313M12 21.75V19.5m0 2.25l-2.25-1.313m0-16.875L12 2.25l2.25 1.313M21 14.25v2.25l-2.25 1.313m-13.5 0L3 16.5v-2.25" />
              </svg>
            </div>
            <div className="flex-1">
              <p className="font-display font-bold text-sm text-white">Explore in 3D</p>
              <p className="text-white/35 text-xs mt-0.5">Walk around the festival grounds with mountains</p>
            </div>
